...
/// </summary>
/// <param name="color">The ARGB_888 integer representing a colour.</param>
...
/// <param name="a">The a component [0, 255].</param>
void ScreenText::setColor(unsigned char r, unsigned char g, unsigned char b, unsigned char a)
{
	//Make a new colour
...
void ScreenText::setText(const std::string& text, const int posX, const int posY, const int fontSize, const int r, const int g, const int b, const int a)
{
